...
ENV NODE_ENV=production OPENCODE_TELEGRAM_HOME=/data OPENCODE_HOME=/data/.local/share/opencode HOME=/data XDG_CONFIG_HOME=/data/.config XDG_DATA_HOME=/data/.local/share XDG_CACHE_HOME=/data/.cache OPEN_BROWSER_ROOTS=/data/workspace PLAYWRIGHT_BROWSERS_PATH=/opt/ms-playwright OPENCODE_EXPERIMENTAL_LSP_TOOL=true OPENCODE_DATA_VOLUME_BUDGET_MB=500 OPENCODE_DATA_VOLUME_WARN_MB=150 OPENCODE_DATA_VOLUME_CRITICAL_MB=100
