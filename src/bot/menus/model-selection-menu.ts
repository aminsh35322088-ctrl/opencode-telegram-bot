...
function sameModel(a: ModelInfo | FavoriteModel, b: ModelInfo | FavoriteModel): boolean {
...
function buildModelSelectionMenuText(currentModel: ModelInfo | undefined, modelLists: ModelSelectionLists): string {
  ...
  return [
    ...
    `🕘 <b>Recent</b> · ${recentCount}`,
    "",
    "Choose a model for this chat, or explore the catalog.",
  ].join("\n");
}
