...
export const MODEL_BUTTON_TEXT_PATTERN = /^🧠\sAI Rules$/;
...
export const ROOT_REPLY_BUTTON_TEXT_PATTERN = /^(?:🕘 History|💬 New Chat|🧠 AI Rules|⚙️ Settings|🎨 Edit Image|📦 Compact: (?:ON|OFF)|⏸️ Pause|▶️ Resume|🛑 Abort)$/;
