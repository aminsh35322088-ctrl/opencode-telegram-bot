...
export const ROOT_REPLY_BUTTON_TEXT_PATTERN = /^(?:🕘 History|💬 New Chat|🎨 New Image Chat|⚙ Main Settings|⚙ Topic Settings|⚙ Settings|🗑 Delete Chat|📦 Compact: (?:ON|OFF)|⏸ Pause|▶ Resume|🛑 Abort|🧠 Model Center)$/u;
