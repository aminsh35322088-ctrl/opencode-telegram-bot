...
export const de: I18nDictionary = {
  ...
  "mcps.detail.needs_auth_hint": "🔐 OAuth-Anmeldung erforderlich. Tippe unten auf Anmelden, um diesen MCP-Server zu autorisieren.",
  "mcps.detail.needs_client_registration_hint": "🪪 Dieser Server erfordert einen vorregistrierten OAuth-Client. Konfiguriere hier Client-ID und optionales Client-Secret, dann mit Anmelden fortfahren.",
  "mcps.auth.sign_in_title": "🔐 Bei {name} anmelden",
  "mcps.auth.sign_in_steps": "1. Tippe auf Anmeldung öffnen und schließe die Autorisierung im Browser ab.\n2. Wenn der Browser auf einer nicht erreichbaren localhost-Seite endet, kopiere die vollständige URL aus der Adressleiste.\n3. Sende diese vollständige Callback-URL hier.\n\nDer Autorisierungscode wird sofort aus Telegram gelöscht und nie an das Modell gesendet.",
  "mcps.auth.cancelled": "Authentifizierungseinrichtung abgebrochen.",
  "mcps.auth.login_cancelled": "MCP-Login abgebrochen.",
  "mcps.auth.setup_cancelled": "MCP-Einrichtung abgebrochen.",
  "mcps.auth.not_waiting_oauth": "Dieser MCP-Server wartet nicht auf OAuth-Login.",
  "mcps.auth.opening_login": "Sicheren MCP-Login wird geöffnet…",
  "mcps.auth.menu_title": "🔐 Authentifizierung · {name}",
  "mcps.auth.server_line": "Server: {url}",
  "mcps.auth.menu_prompt": "Wähle, wie dieser Remote-MCP-Server sich authentifiziert.",
  "mcps.auth.menu_options": "✨ Automatisch / OAuth — empfohlen, wenn der Server Browser-Login unterstützt\n🔑 Bearer-Token — Authorization: Bearer …\n🗝 API-Key — standardmäßig X-API-Key\n🧩 eigener Header — für anbieterspezifische Header\n🪪 OAuth-Client — vorregistrierte Client-ID / -Secret",
  "mcps.auth.secrets_note": "Secrets werden vom Bot verschlüsselt und dem Modell nie angezeigt.",
  "mcps.auth.outside_context": "🔒 Zugangsdaten bleiben außerhalb des Modellkontexts.",
  "mcps.auth.header_name_prompt": "Sende den von diesem MCP-Server verwendeten HTTP-Header-Namen.\n\nBeispiel: X-Service-Token",
  "mcps.auth.bearer_prompt": "Sende das Bearer-Token.\n\nDie Nachricht wird sofort gelöscht.",
  "mcps.auth.api_key_prompt": "Sende den API-Key für X-API-Key.\n\nDie Nachricht wird sofort gelöscht.",
  "mcps.auth.custom_header_prompt": "Sende den Wert für {header}.\n\nDie Nachricht wird sofort gelöscht.",
  "mcps.auth.client_id_prompt": "Sende die vorregistrierte OAuth-Client-ID.",
  "mcps.auth.client_secret_prompt": "Sende das Client-Secret oder tippe auf Secret überspringen, falls dies ein öffentlicher Client ist.\n\nDie Nachricht wird sofort gelöscht.",
  "mcps.auth.scope_prompt": "Sende den vom Anbieter angeforderten OAuth-Scope oder tippe auf Scope überspringen, um den Serverstandard zu verwenden.",
  "mcps.auth.configure_failed": "❌ Authentifizierung konnte nicht konfiguriert werden.\nPrüfe die Zugangsdaten oder Anbieter-Einstellungen und versuche es erneut.\n\nDas gesendete Secret wurde weder angezeigt noch protokolliert.",
  "mcps.auth.mode.bearer": "Bearer-Token",
  "mcps.auth.mode.api_key": "API-Key",
  "mcps.auth.mode.custom_header": "Eigener Header",
  "mcps.auth.mode.oauth_client": "OAuth-Client",
  "mcps.auth.step_title": "🔐 {mode} · {name}",
  "mcps.auth.step_title_client": "🪪 OAuth-Client · {name}",
  "mcps.button.rename": "✏️ Umbenennen",
  "mcps.button.delete": "🗑 Löschen",
  "mcps.button.confirm_delete": "🗑 Ja, löschen",
  "mcps.rename.prompt": "✏️ MCP-Server umbenennen\n\nAktueller Name: {name}\n\nSende den neuen Servernamen.",
  "mcps.rename.retry": "✏️ MCP-Server umbenennen\n\n❌ {error}\n\nSende einen anderen Namen.",
  "mcps.rename.name_too_long": "Der Name darf höchstens 128 Zeichen lang sein.",
  "mcps.delete.confirm": "🗑 MCP-Server löschen\n\n{name} löschen?\n\nDefinition und gespeicherte Anmeldung werden entfernt und aktive Laufzeiten getrennt.",
  "mcps.deleted": "MCP-Server {name} gelöscht.",
  "mcps.auth.account": "👤 Konto: {identity}{provider}",
  "mcps.auth.account_unknown": "👤 Konto: Angemeldet{provider} · Anbieter stellt keine E-Mail/Benutzerkennung bereit",
  "model.fallback.notice": "⚠️ Das ausgewählte Modell {previous} ist nicht verfügbar oder nicht agentfähig. Gewechselt zu {next}.",
