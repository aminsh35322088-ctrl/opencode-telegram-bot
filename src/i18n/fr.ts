...
export const fr: I18nDictionary = {
  ...
  "messages.button.redo": "↪️ Rétablir",
  ...
  "messages.redo_error": "❌ Échec du rétablissement. Veuillez réessayer.",
  "messages.fork_success": "🔀 Fork créé à partir du message :\n\n{text}",
  "messages.fork_error": "❌ Échec de la création du fork. Veuillez réessayer.",
  "session.no_session": "ℹ️ Aucune session OpenCode active. Ouvrez ou attachez d'abord une session.",
  "session.header": "🧭 Session OpenCode",
  "session.state": "État : {status}",
  "session.status_idle": "🟢 inactive",
  "session.status_busy": "🟡 occupée",
  "session.status_retry": "🔁 nouvelle tentative",
  "session.status_unknown": "⚪ inconnu",
  "session.todos_none": "📝 Tâches : aucune",
  "session.todos_summary": "📝 Tâches : {total} au total · {active} actives · {done} terminées",
  "session.todos_unavailable": "📝 Tâches : indisponible",
  "session.changes_none": "🧩 Modifications : aucune",
  "session.changes_summary": "🧩 Modifications : {files} fichiers · +{additions} / -{deletions}",
  "session.changes_unavailable": "🧩 Modifications : indisponible",
  "session.children_none": "🌿 Sous-sessions : aucune",
  "session.children_summary": "🌿 Sous-sessions : {count}",
  "session.children_unavailable": "🌿 Sous-sessions : indisponible",
  "session.more": "…et {count} de plus",
  ...
  "skills.button.refresh": "🔄 Actualiser",
  ...
  "skills.button.new": "➕ Nouvelle skill",
  "skills.button.delete": "🗑 Supprimer la skill",
  "skills.button.edit": "✏️ Modifier la skill",
  "skills.button.delete_confirm": "🗑 Supprimer définitivement",
  "skills.button.delete_cancel": "Annuler",
  "skills.wizard.ask_name": "Envoyez le nom de la skill (minuscules, chiffres, tirets — ex. deploy-check).",
  "skills.wizard.invalid_name": "⚠️ Nom de skill invalide. Utilisez minuscules, chiffres et tirets simples (1-64 caractères), ex. deploy-check.",
  "skills.wizard.ask_description": "Envoyez maintenant la description en une ligne : quand l’agent doit-il utiliser cette skill ?",
  "skills.wizard.ask_body": "Envoyez maintenant le corps de la skill (instructions Markdown). Conseil : restez précis et actionnable.",
  "skills.wizard.saved": "✅ Skill \"{name}\" enregistrée dans le répertoire global des skills.",
  "skills.wizard.write_error": "🔴 Impossible d'enregistrer la skill : {error}",
  "skills.wizard.cancelled": "Assistant de skill annulé.",
  "skills.restart_hint": "Redémarrez OpenCode (/opencode_stop + /opencode_start) pour charger le changement.",
  "skills.delete_not_managed": "Seules les skills du répertoire global peuvent être supprimées.",
  "skills.delete_confirm": "Supprimer la skill {skill} ? Son dossier sera retiré du répertoire global.",
  "skills.deleted": "🗑 Skill \"{name}\" supprimée.",
  "skills.delete_failed": "🔴 Impossible de supprimer la skill.",
  "skills.edit_not_managed": "Seules les skills du répertoire global des skills peuvent être modifiées.",
  "skills.edit.ask_description": "Envoie la nouvelle description en une ligne pour la skill \"{name}\".",
  "skills.edit.ask_body": "Envoie maintenant le nouveau contenu de la skill (instructions Markdown). Il remplacera le contenu actuel.",
  "skills.edit.saved": "✅ Skill \"{name}\" mise à jour.",
  "skills.button.import": "📥 Importer depuis GitHub",
  "skills.button.import_confirm": "⬇️ Importer",
  "skills.import.ask_url": "Envoie un lien GitHub vers un skill : dépôt, dossier du skill ou fichier SKILL.md.",
  "skills.import.invalid_url": "⚠️ Ce n'est pas un lien GitHub valide. Envoie une URL de dépôt, de dossier ou de fichier SKILL.md.",
  "skills.import.not_found": "🔴 Aucun SKILL.md trouvé à cet emplacement GitHub.",
  "skills.import.fetch_error": "🔴 Échec de la récupération depuis GitHub : {error}",
  "skills.import.confirm": "Importer le skill {skill} ?\n\n{description}\n\n📍 Source : {url}",
  "skills.import.multiple_found": "{count} skills trouvés à cet emplacement. Choisis-en un à importer :",
  "skills.imported": "✅ Skill \"{name}\" importé depuis GitHub.",
  "skills.import.exists": "⚠️ Le skill \"{name}\" existe déjà. Modifie-le ou supprime-le d'abord.",
  "skills.import.cancelled": "Importation du skill annulée.",
  ...
  "mcps.detail.needs_auth_hint": "🔐 Connexion OAuth requise. Touchez Se connecter ci-dessous pour autoriser ce serveur MCP.",
  "mcps.detail.needs_client_registration_hint": "🪪 Ce serveur nécessite un client OAuth préenregistré. Configurez ici le Client ID et le Client Secret optionnel, puis continuez avec Se connecter.",
  "mcps.auth.sign_in_title": "🔐 Se connecter à {name}",
  "mcps.auth.sign_in_steps": "1. Touchez Ouvrir la connexion et terminez l'autorisation dans le navigateur.\n2. Si le navigateur s'arrête sur une page localhost indisponible, copiez l'URL complète depuis la barre d'adresse.\n3. Envoyez cette URL de callback complète ici.\n\nLe code d'autorisation est immédiatement supprimé de Telegram et n'est jamais envoyé au modèle.",
  "mcps.auth.cancelled": "Configuration d'authentification annulée.",
  "mcps.auth.login_cancelled": "Connexion MCP annulée.",
  "mcps.auth.setup_cancelled": "Configuration MCP annulée.",
  "mcps.auth.not_waiting_oauth": "Ce serveur MCP n'attend pas de connexion OAuth.",
  "mcps.auth.opening_login": "Ouverture de la connexion MCP sécurisée…",
  "mcps.auth.menu_title": "🔐 Authentification · {name}",
  "mcps.auth.server_line": "Serveur : {url}",
  "mcps.auth.menu_prompt": "Choisissez comment ce serveur MCP distant s'authentifie.",
  "mcps.auth.menu_options": "✨ Auto / OAuth — recommandé si le serveur prend en charge la connexion navigateur\n🔑 Jeton Bearer — Authorization: Bearer …\n🗝 Clé API — X-API-Key par défaut\n🧩 En-tête personnalisé — pour les en-têtes du fournisseur\n🪪 Client OAuth — Client ID / Secret préenregistrés",
  "mcps.auth.secrets_note": "Les secrets sont chiffrés par le bot et ne sont jamais affichés au modèle.",
  "mcps.auth.outside_context": "🔒 Les identifiants restent hors du contexte du modèle.",
  "mcps.auth.header_name_prompt": "Envoyez le nom d'en-tête HTTP utilisé par ce serveur MCP.\n\nExemple : X-Service-Token",
  "mcps.auth.bearer_prompt": "Envoyez le jeton bearer.\n\nLe message sera immédiatement supprimé.",
  "mcps.auth.api_key_prompt": "Envoyez la clé API pour X-API-Key.\n\nLe message sera immédiatement supprimé.",
  "mcps.auth.custom_header_prompt": "Envoyez la valeur pour {header}.\n\nLe message sera immédiatement supprimé.",
  "mcps.auth.client_id_prompt": "Envoyez le Client ID OAuth préenregistré.",
  "mcps.auth.client_secret_prompt": "Envoyez le Client Secret ou touchez Ignorer le secret s'il s'agit d'un client public.\n\nLe message sera immédiatement supprimé.",
  "mcps.auth.scope_prompt": "Envoyez la portée OAuth demandée par le fournisseur ou touchez Ignorer la portée pour utiliser la valeur par défaut du serveur.",
  "mcps.auth.configure_failed": "❌ Impossible de configurer l'authentification.\nVérifiez l'identifiant ou les paramètres du fournisseur puis réessayez.\n\nLe secret soumis n'a été ni affiché ni journalisé.",
  "mcps.auth.mode.bearer": "Jeton Bearer",
  "mcps.auth.mode.api_key": "Clé API",
  "mcps.auth.mode.custom_header": "En-tête personnalisé",
