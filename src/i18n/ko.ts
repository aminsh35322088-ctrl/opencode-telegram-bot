...
export const ko: I18nDictionary = {
  ...
  "bot.video_downloading": "⏳ 비디오 다운로드 중...",
  "bot.video_too_large": "⚠️ 비디오가 너무 큽니다 (최대 {maxSizeMb}MB)",
  "bot.video_error": "🔴 비디오 처리 실패",
  ...
  "messages.redo_error": "❌ 다시 실행하지 못했습니다. 다시 시도하세요.",
  "messages.fork_success": "🔀 이 메시지에서 포크를 만들었습니다:\n\n{text}",
  "messages.fork_error": "❌ 포크 생성에 실패했습니다. 다시 시도해 주세요.",
  "session.no_session": "ℹ️ 활성 OpenCode 세션이 없습니다. 먼저 세션을 열거나 연결하세요.",
  "session.header": "🧭 OpenCode 세션",
  "session.state": "상태: {status}",
  "session.status_idle": "🟢 유",
  "session.status_busy": "🟡 사용 중",
  "session.status_retry": "🔁 재시도",
  "session.status_unknown": "⚪ 알 수 없음",
  "session.todos_none": "📝 작업: 없음",
  "session.todos_summary": "📝 작업: 총 {total}개 · 활성 {active}개 · 완료 {done}개",
  "session.todos_unavailable": "📝 작업: 사용 불가",
  "session.changes_none": "🧩 변경: 없음",
  "session.changes_summary": "🧩 변경: 파일 {files}개 · +{additions} / -{deletions}",
  "session.changes_unavailable": "🧩 변경: 사용 불가",
  "session.children_none": "🌿 하위 세션: 없음",
  "session.children_summary": "🌿 하위 세션: {count}",
  "session.children_unavailable": "🌿 하위 세션: 사용 불가",
  "session.more": "…그 외 {count}개",
  ...
  "skills.button.delete_confirm": "🗑 영구 삭제",
  "skills.button.delete_cancel": "취소",
  "skills.wizard.ask_name": "스킬 이름을 보내세요 (소문자, 숫자, 하이픈 — 예: deploy-check).",
  "skills.wizard.invalid_name": "⚠️ 잘못된 스킬 이름입니다. 소문자, 숫자, 단일 하이픈(1-64자)을 사용하세요. 예: deploy-check.",
  "skills.wizard.ask_description": "이제 한 줄 설명을 보내세요: 에이전트가 이 스킬을 언제 사용해야 하나요?",
  "skills.wizard.ask_body": "이제 스킬 본문을 보내세요 (Markdown 지침). 팁: 집중되고 실행 가능하게 유지하세요.",
  "skills.wizard.saved": "✅ 스킬 \"{name}\"이(가) 전역 스킬 디렉터리에 저장되었습니다.",
  "skills.wizard.write_error": "🔴 스킬을 저장할 수 없습니다: {error}",
  "skills.wizard.cancelled": "스킬 마법사가 취소되었습니다.",
  "skills.restart_hint": "변경 사항을 불러오려면 OpenCode를 재시작하세요 (/opencode_stop + /opencode_start).",
  "skills.delete_not_managed": "전역 스킬 디렉터리의 스킬만 삭제할 수 있습니다.",
  "skills.delete_confirm": "스킬 {skill}을(를) 삭제할까요? 폴더가 전역 디렉터리에서 제거됩니다.",
  "skills.deleted": "🗑 스킬 \"{name}\" 삭제됨.",
  "skills.delete_failed": "🔴 스킬을 삭제할 수 없습니다.",
  "skills.edit_not_managed": "전역 스킬 디렉터리의 스킬만 편집할 수 있습니다.",
  "skills.edit.ask_description": "스킬 \"{name}\"의 새 한 줄 설명을 보내 주세요.",
  "skills.edit.ask_body": "이제 새 스킬 본문(Markdown 지침)을 보내 주세요. 현재 내용을 대체합니다.",
  "skills.edit.saved": "✅ 스킬 \"{name}\"이(가) 업데이트되었습니다.",
  "skills.button.import": "📥 GitHub에서 가져오기",
  "skills.button.import_confirm": "⬇️ 가져오기",
  "skills.import.ask_url": "스킬의 GitHub 링크를 보내세요: 저장소, 스킬 폴더 또는 SKILL.md 파일.",
  "skills.import.invalid_url": "⚠️ 유효한 GitHub 스킬 링크가 아닙니다. 저장소, 폴더 또는 SKILL.md URL을 보내세요.",
  "skills.import.not_found": "🔴 해당 GitHub 위치에서 SKILL.md를 찾을 수 없습니다.",
  "skills.import.fetch_error": "🔴 GitHub에서 가져오지 못했습니다: {error}",
  "skills.import.confirm": "스킬 {skill}을(를) 가져올까요?\n\n{description}\n\n📍 출처: {url}",
  "skills.import.multiple_found": "해당 위치에서 스킬 {count}개를 찾았습니다. 가져올 스킬을 선택하세요:",
  "skills.imported": "✅ 스킬 \"{name}\"을(를) GitHub에서 가져왔습니다.",
  "skills.import.exists": "⚠️ 스킬 \"{name}\"이(가) 이미 존재합니다. 먼저 편집하거나 삭제하세요.",
  "skills.import.cancelled": "스킬 가져오기가 취소되었습니다.",
  ...
  "mcps.detail.needs_auth_hint": "🔐 OAuth 로그인이 필요합니다. 아래 로그인을 눌러 이 MCP 서버를 승인하세요.",
  "mcps.detail.needs_client_registration_hint": "🪪 이 서버는 사전 등록된 OAuth 클라이언트가 필요합니다. 여기에서 Client ID와 선택적 Client Secret을 설정한 다음 로그인으로 계속하세요.",
  "mcps.auth.sign_in_title": "🔐 {name}에 로그인",
  "mcps.auth.sign_in_steps": "1. 로그인 열기를 누르고 브라우저에서 승인을 완료하세요.\n2. 브라우저가 사용할 수 없는 localhost 페이지에서 끝나면 주소창에서 전체 URL을 복사하세요.\n3. 그 전체 콜백 URL을 여기로 보내세요.\n\n인증 코드는 Telegram에서 즉시 삭제되며 모델로 전송되지 않습니다.",
  "mcps.auth.cancelled": "인증 설정이 취소되었습니다.",
  "mcps.auth.login_cancelled": "MCP 로그인이 취소되었습니다.",
  "mcps.auth.setup_cancelled": "MCP 설정이 취소되었습니다.",
  "mcps.auth.not_waiting_oauth": "이 MCP 서버는 OAuth 로그인을 기다리고 있지 않습니다.",
  "mcps.auth.opening_login": "보안 MCP 로그인을 여는 중…",
  "mcps.auth.menu_title": "🔐 인증 · {name}",
  "mcps.auth.server_line": "서버: {url}",
  "mcps.auth.menu_prompt": "이 원격 MCP 서버의 인증 방식을 선택하세요.",
  "mcps.auth.menu_options": "✨ 자동 / OAuth — 서버가 브라우저 로그인을 지원할 때 권장\n🔑 Bearer 토큰 — Authorization: Bearer …\n🗝 API 키 — 기본은 X-API-Key\n🧩 사용자 지정 헤더 — 제공업체별 헤더용\n🪪 OAuth 클라이언트 — 사전 등록된 Client ID / Secret",
  "mcps.auth.secrets_note": "비밀은 봇이 암호화하며 모델에 절대 표시되지 않습니다.",
  "mcps.auth.outside_context": "🔒 자격 증명은 모델 컨텍스트 밖에 유지됩니다.",
  "mcps.auth.header_name_prompt": "이 MCP 서버가 사용하는 HTTP 헤더 이름을 보내세요.\n\n예: X-Service-Token",
  "mcps.auth.bearer_prompt": "Bearer 토큰을 보내세요.\n\n메시지는 즉시 삭제됩니다.",
  "mcps.auth.api_key_prompt": "X-API-Key용 API 키를 보내세요.\n\n메시지는 즉시 삭제됩니다.",
  "mcps.auth.custom_header_prompt": "{header} 값을 보내세요.\n\n메시지는 즉시 삭제됩니다.",
  "mcps.auth.client_id_prompt": "사전 등록된 OAuth Client ID를 보내세요.",
  "mcps.auth.client_secret_prompt": "Client Secret을 보내거나 공개 클라이언트라면 비밀 건너뛰기를 누르세요.\n\n메시지는 즉시 삭제됩니다.",
  "mcps.auth.scope_prompt": "제공업체가 요청하는 OAuth 범위를 보내거나 서버 기본값을 사용하려면 범위 건너뛰기를 누르세요.",
  "mcps.auth.configure_failed": "❌ 인증을 구성할 수 없습니다.\n자격 증명 또는 제공업체 설정을 확인한 후 다시 시도하세요.\n\n전송된 비밀은 표시되거나 기록되지 않았습니다.",
  "mcps.auth.mode.bearer": "Bearer 토큰",
  "mcps.auth.mode.api_key": "API 키",
  "mcps.auth.mode.custom_header": "사용자 지정 헤더",
