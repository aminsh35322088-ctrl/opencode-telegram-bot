...
export const it: I18nDictionary = {
  ...
  "bot.empty_response":
    "⚠️ Il modello ha terminato senza produrre testo. Riformula la richiesta o usa /abort e riprova.",
  "bot.session_stalled":
    "⏸️ Il modello ha smesso di progredire e l'esecuzione è stata interrotta. Nessuna risposta prodotta; riprova.",
  ...
  "bot.video_downloading": "⏳ Download video in corso...",
  "bot.video_too_large": "⚠️ Il video è troppo grande (max {maxSizeMb}MB)",
  "bot.video_error": "🔴 Elaborazione del video fallita",
  ...
  "messages.redo_error": "❌ Ripristino non riuscito. Riprova.",
  "messages.fork_success": "🔀 Fork creato dal messaggio:\n\n{text}",
  "messages.fork_error": "❌ Creazione del fork non riuscita. Riprova.",
  "session.no_session": "ℹ️ Nessuna sessione OpenCode attiva. Apri o collega prima una sessione.",
  "session.header": "🧭 Sessione OpenCode",
  "session.state": "Stato: {status}",
  "session.status_idle": "🟢 inattiva",
  "session.status_busy": "🟡 occupata",
  "session.status_retry": "🔁 nuovo tentativo",
  "session.status_unknown": "⚪ sconosciuto",
  "session.todos_none": "📝 Attività: nessuna",
  "session.todos_summary": "📝 Attività: {total} totali · {active} attive · {done} completate",
  "session.todos_unavailable": "📝 Attività: non disponibile",
  "session.changes_none": "🧩 Modifiche: nessuna",
  "session.changes_summary": "🧩 Modifiche: {files} file · +{additions} / -{deletions}",
  "session.changes_unavailable": "🧩 Modifiche: non disponibile",
  "session.children_none": "🌿 Sotto-sessioni: nessuna",
  "session.children_summary": "🌿 Sotto-sessioni: {count}",
  "session.children_unavailable": "🌿 Sotto-sessioni: non disponibile",
  "session.more": "…e altri {count}",
  ...
  "skills.button.refresh": "🔄 Aggiorna",
  ...
  "skills.button.edit": "✏️ Modifica skill",
  ...
  "skills.edit_not_managed": "È possibile modificare solo le skill nella directory globale delle skill.",
  "skills.edit.ask_description": "Invia la nuova descrizione su una riga per la skill \"{name}\".",
  "skills.edit.ask_body": "Ora invia il nuovo corpo della skill (istruzioni in Markdown). Sostituirà il contenuto attuale.",
  "skills.edit.saved": "✅ Skill \"{name}\" aggiornata.",
  "skills.button.import": "📥 Importa da GitHub",
  "skills.button.import_confirm": "⬇️ Importa",
  "skills.import.ask_url": "Invia un link GitHub a una skill: repository, cartella della skill o file SKILL.md.",
  "skills.import.invalid_url": "⚠️ Questo non è un link GitHub valido. Invia un URL di repository, cartella o file SKILL.md.",
  "skills.import.not_found": "🔴 Nessun SKILL.md trovato in questo percorso GitHub.",
  "skills.import.fetch_error": "🔴 Impossibile recuperare da GitHub: {error}",
  "skills.import.confirm": "Importare la skill {skill}?\n\n{description}\n\n📍 Fonte: {url}",
  "skills.import.multiple_found": "Trovate {count} skill in questo percorso. Scegline una da importare:",
  "skills.imported": "✅ Skill \"{name}\" importata da GitHub.",
  "skills.import.exists": "⚠️ La skill \"{name}\" esiste già. Modificala o eliminala prima.",
  "skills.import.cancelled": "Importazione skill annullata.",
  ...
  "mcps.detail.needs_auth_hint": "🔐 È richiesto l'accesso OAuth. Tocca Accedi qui sotto per autorizzare questo server MCP.",
  "mcps.detail.needs_client_registration_hint": "🪪 Questo server richiede un client OAuth pre-registrato. Configura qui Client ID e Client Secret opzionale, poi continua con Accedi.",
  "mcps.auth.sign_in_title": "🔐 Accedi a {name}",
  "mcps.auth.sign_in_steps": "1. Tocca Apri accesso e completa l'autorizzazione nel browser.\n2. Se il browser finisce su una pagina localhost non disponibile, copia l'URL completo dalla barra degli indirizzi.\n3. Invia qui quell'URL di callback completo.\n\nIl codice di autorizzazione viene subito eliminato da Telegram e non viene mai inviato al modello.",
  "mcps.auth.cancelled": "Configurazione autenticazione annullata.",
  "mcps.auth.login_cancelled": "Accesso MCP annullato.",
  "mcps.auth.setup_cancelled": "Configurazione MCP annullata.",
  "mcps.auth.not_waiting_oauth": "Questo server MCP non sta aspettando l'accesso OAuth.",
  "mcps.auth.opening_login": "Apertura accesso MCP sicuro…",
  "mcps.auth.menu_title": "🔐 Autenticazione · {name}",
  "mcps.auth.server_line": "Server: {url}",
  "mcps.auth.menu_prompt": "Scegli come si autentica questo server MCP remoto.",
  "mcps.auth.menu_options": "✨ Automatico / OAuth — consigliato se il server supporta l'accesso dal browser\n🔑 Token Bearer — Authorization: Bearer …\n🗝 Chiave API — X-API-Key predefinito\n🧩 Intestazione personalizzata — per intestazioni del provider\n🪪 Client OAuth — Client ID / Secret pre-registrati",
  "mcps.auth.secrets_note": "I segreti sono crittografati dal bot e non vengono mai mostrati al modello.",
  "mcps.auth.outside_context": "🔒 Le credenziali restano fuori dal contesto del modello.",
  "mcps.auth.header_name_prompt": "Invia il nome dell'intestazione HTTP usato da questo server MCP.\n\nEsempio: X-Service-Token",
  "mcps.auth.bearer_prompt": "Invia il token bearer.\n\nIl messaggio verrà eliminato subito.",
  "mcps.auth.api_key_prompt": "Invia la chiave API per X-API-Key.\n\nIl messaggio verrà eliminato subito.",
  "mcps.auth.custom_header_prompt": "Invia il valore per {header}.\n\nIl messaggio verrà eliminato subito.",
  "mcps.auth.client_id_prompt": "Invia il Client ID OAuth pre-registrato.",
  "mcps.auth.client_secret_prompt": "Invia il Client Secret o tocca Salta secret se è un client pubblico.\n\nIl messaggio verrà eliminato subito.",
  "mcps.auth.scope_prompt": "Invia lo scope OAuth richiesto dal provider o tocca Salta scope per usare il predefinito del server.",
  "mcps.auth.configure_failed": "❌ Impossibile configurare l'autenticazione.\nControlla le credenziali o le impostazioni del provider e riprova.\n\nIl secret inviato non è stato mostrato né registrato nei log.",
  "mcps.auth.mode.bearer": "Token Bearer",
  "mcps.auth.mode.api_key": "Chiave API",
  "mcps.auth.mode.custom_header": "Intestazione personalizzata",
  "mcps.auth.mode.oauth_client": "Client OAuth",
  "mcps.auth.step_title": "🔐 {mode} · {name}",
  "mcps.auth.step_title_client": "🪪 Client OAuth · {name}",
  "mcps.button.rename": "✏️ Rinomina",
  "mcps.button.delete": "🗑 Elimina",
  "mcps.button.confirm_delete": "🗑 Sì, elimina",
  "mcps.rename.prompt": "✏️ Rinomina server MCP\n\nNome attuale: {name}\n\nInvia il nuovo nome.",
  "mcps.rename.retry": "✏️ Rinomina server MCP\n\n❌ {error}\n\nInvia un altro nome.",
  "mcps.rename.name_too_long": "Il nome deve contenere al massimo 128 caratteri.",
  "mcps.delete.confirm": "🗑 Elimina server MCP\n\nEliminare {name}?\n\nLa definizione e l’autenticazione salvata verranno rimosse e i runtime attivi disconnessi.",
  "mcps.deleted": "Server MCP {name} eliminato.",
  "mcps.auth.account": "👤 Account: {identity}{provider}",
  "mcps.auth.account_unknown": "👤 Account: Accesso effettuato{provider} · il provider non espone email/username",
  "model.fallback.notice": "⚠️ Il modello selezionato {previous} non è disponibile o non è adatto a un agente. Passato a {next}.",
