...
export const pt: I18nDictionary = {
  ...
  "bot.video_downloading": "⏳ Baixando vídeo...",
  "bot.video_too_large": "⚠️ O vídeo é muito grande (máx. {maxSizeMb}MB)",
  "bot.video_error": "🔴 Falha ao processar o vídeo",
  ...
  "messages.button.redo": "↪️ Refazer",
  ...
  "messages.redo_error": "❌ Falha ao refazer. Tente novamente.",
  "messages.fork_success": "🔀 Fork criado a partir da mensagem:\n\n{text}",
  "messages.fork_error": "❌ Não foi possível criar o fork. Tente novamente.",
  "session.no_session": "ℹ️ Nenhuma sessão OpenCode ativa. Abra ou conecte-se a uma sessão primeiro.",
  "session.header": "🧭 Sessão OpenCode",
  "session.state": "Estado: {status}",
  "session.status_idle": "🟢 ociosa",
  "session.status_busy": "🟡 ocupada",
  "session.status_retry": "🔁 tentando novamente",
  "session.status_unknown": "⚪ desconhecido",
  "session.todos_none": "📝 Tarefas: nenhuma",
  "session.todos_summary": "📝 Tarefas: {total} no total · {active} ativas · {done} concluídas",
  "session.todos_unavailable": "📝 Tarefas: indisponível",
  "session.changes_none": "🧩 Alterações: nenhuma",
  "session.changes_summary": "🧩 Alterações: {files} arquivos · +{additions} / -{deletions}",
  "session.changes_unavailable": "🧩 Alterações: indisponível",
  "session.children_none": "🌿 Subsessões: nenhuma",
  "session.children_summary": "🌿 Subsessões: {count}",
  "session.children_unavailable": "🌿 Subsessões: indisponível",
  "session.more": "…e mais {count}",
  ...
  "skills.button.refresh": "🔄 Atualizar",
  ...
  "skills.edit_not_managed": "Somente skills do diretório global de skills podem ser editadas.",
  "skills.edit.ask_description": "Envie a nova descrição de uma linha para a skill \"{name}\".",
  "skills.edit.ask_body": "Agora envie o novo corpo da skill (instruções em Markdown). Ele substituirá o conteúdo atual.",
  "skills.edit.saved": "✅ Skill \"{name}\" atualizada.",
  "skills.button.import": "📥 Importar do GitHub",
  "skills.button.import_confirm": "⬇️ Importar",
  "skills.import.ask_url": "Envie um link do GitHub para uma skill: repositório, pasta da skill ou arquivo SKILL.md.",
  "skills.import.invalid_url": "⚠️ Este não é um link válido do GitHub. Envie uma URL de repositório, pasta ou SKILL.md.",
  "skills.import.not_found": "🔴 Nenhum SKILL.md foi encontrado nesse local do GitHub.",
  "skills.import.fetch_error": "🔴 Não foi possível buscar do GitHub: {error}",
  "skills.import.confirm": "Importar a skill {skill}?\n\n{description}\n\n📍 Fonte: {url}",
  "skills.import.multiple_found": "Foram encontradas {count} skills nesse local. Escolha uma para importar:",
  "skills.imported": "✅ Skill \"{name}\" importada do GitHub.",
  "skills.import.exists": "⚠️ A skill \"{name}\" já existe. Edite ou exclua primeiro.",
  "skills.import.cancelled": "Importação da skill cancelada.",
  ...
  "mcps.detail.needs_auth_hint": "🔐 É necessário o login OAuth. Toque em Entrar abaixo para autorizar este servidor MCP.",
  "mcps.detail.needs_client_registration_hint": "🪪 Este servidor requer um cliente OAuth pré-registrado. Configure aqui o Client ID e o Client Secret opcional e continue com Entrar.",
  "mcps.auth.sign_in_title": "🔐 Entrar em {name}",
  "mcps.auth.sign_in_steps": "1. Toque em Abrir login e conclua a autorização no navegador.\n2. Se o navegador terminar em uma página localhost indisponível, copie a URL completa da barra de endereço.\n3. Envie essa URL de callback completa aqui.\n\nO código de autorização é excluído do Telegram imediatamente e nunca é enviado ao modelo.",
  "mcps.auth.cancelled": "Configuração de autenticação cancelada.",
  "mcps.auth.login_cancelled": "Login MCP cancelado.",
  "mcps.auth.setup_cancelled": "Configuração MCP cancelada.",
  "mcps.auth.not_waiting_oauth": "Este servidor MCP não está aguardando login OAuth.",
  "mcps.auth.opening_login": "Abrindo login MCP seguro…",
  "mcps.auth.menu_title": "🔐 Autenticação · {name}",
  "mcps.auth.server_line": "Servidor: {url}",
  "mcps.auth.menu_prompt": "Escolha como este servidor MCP remoto se autentica.",
  "mcps.auth.menu_options": "✨ Automático / OAuth — recomendado quando o servidor suporta login no navegador\n🔑 Token Bearer — Authorization: Bearer …\n🗝 Chave API — X-API-Key por padrão\n🧩 Cabeçalho personalizado — para cabeçalhos do provedor\n🪪 Cliente OAuth — Client ID / Secret pré-registrados",
  "mcps.auth.secrets_note": "Os segredos são criptografados pelo bot e nunca são exibidos ao modelo.",
  "mcps.auth.outside_context": "🔒 As credenciais permanecem fora do contexto do modelo.",
  "mcps.auth.header_name_prompt": "Envie o nome do cabeçalho HTTP usado por este servidor MCP.\n\nExemplo: X-Service-Token",
  "mcps.auth.bearer_prompt": "Envie o token bearer.\n\nA mensagem será excluída imediatamente.",
  "mcps.auth.api_key_prompt": "Envie a chave de API para X-API-Key.\n\nA mensagem será excluída imediatamente.",
  "mcps.auth.custom_header_prompt": "Envie o valor para {header}.\n\nA mensagem será excluída imediatamente.",
  "mcps.auth.client_id_prompt": "Envie o Client ID OAuth pré-registrado.",
  "mcps.auth.client_secret_prompt": "Envie o Client Secret ou toque em Pular secret se este for um cliente público.\n\nA mensagem será excluída imediatamente.",
  "mcps.auth.scope_prompt": "Envie o escopo OAuth solicitado pelo provedor ou toque em Pular escopo para usar o padrão do servidor.",
  "mcps.auth.configure_failed": "❌ Não foi possível configurar a autenticação.\nVerifique a credencial ou as configurações do provedor e tente novamente.\n\nO segredo enviado não foi exibido nem registrado em log.",
  "mcps.auth.mode.bearer": "Token Bearer",
  "mcps.auth.mode.api_key": "Chave de API",
  "mcps.auth.mode.custom_header": "Cabeçalho personalizado",
  "mcps.auth.mode.oauth_client": "Cliente OAuth",
  "mcps.auth.step_title": "🔐 {mode} · {name}",
  "mcps.auth.step_title_client": "🪪 Cliente OAuth · {name}",
  "mcps.button.rename": "✏️ Renomear",
  "mcps.button.delete": "🗑 Excluir",
  "mcps.button.confirm_delete": "🗑 Sim, excluir",
  "mcps.rename.prompt": "✏️ Renomear servidor MCP\n\nNome atual: {name}\n\nEnvie o novo nome.",
  "mcps.rename.retry": "✏️ Renomear servidor MCP\n\n❌ {error}\n\nEnvie outro nome.",
  "mcps.rename.name_too_long": "O nome deve ter no máximo 128 caracteres.",
  "mcps.delete.confirm": "🗑 Excluir servidor MCP\n\nExcluir {name}?\n\nA definição e a autenticação salva serão removidas e os runtimes ativos desconectados.",
  "mcps.deleted": "Servidor MCP {name} excluído.",
  "mcps.auth.account": "👤 Conta: {identity}{provider}",
  "mcps.auth.account_unknown": "👤 Conta: Conectada{provider} · o provedor não expôs email/usuário",
  "model.fallback.notice": "⚠️ O modelo selecionado {previous} está indisponível ou não é adequado para agente. Alterado para {next}.",



  "stt.uncertain": "🎤 Algumas palavras podem estar incorretas. Revise e envie o texto corrigido:",
