...
export const es: I18nDictionary = {
  ...
  "bot.empty_response":
    "⚠️ El modelo terminó sin producir texto. Reformule la solicitud o use /abort e inténtelo de nuevo.",
  "bot.session_stalled":
    "⏸️ El modelo dejó de progresar y la ejecución se detuvo. No se produjo ninguna respuesta; inténtelo de nuevo.",
  ...
  "messages.button.redo": "↪️ Rehacer",
  ...
  "messages.redo_error": "❌ No se pudo rehacer. Inténtalo de nuevo.",
  "messages.fork_success": "🔀 Fork creado desde el mensaje:\n\n{text}",
  "messages.fork_error": "❌ No se pudo crear el fork. Inténtalo de nuevo.",
  "session.no_session": "ℹ️ No hay una sesión de OpenCode activa. Abre o conéctate a una sesión primero.",
  "session.header": "🧭 Sesión de OpenCode",
  "session.state": "Estado: {status}",
  "session.status_idle": "🟢 inactiva",
  "session.status_busy": "🟡 ocupada",
  "session.status_retry": "🔁 reintentando",
  "session.status_unknown": "⚪ desconocido",
  "session.todos_none": "📝 Tareas: ninguna",
  "session.todos_summary": "📝 Tareas: {total} en total · {active} activas · {done} hechas",
  "session.todos_unavailable": "📝 Tareas: no disponible",
  "session.changes_none": "🧩 Cambios: ninguno",
  "session.changes_summary": "🧩 Cambios: {files} archivos · +{additions} / -{deletions}",
  "session.changes_unavailable": "🧩 Cambios: no disponible",
  "session.children_none": "🌿 Subsesiones: ninguna",
  "session.children_summary": "🌿 Subsesiones: {count}",
  "session.children_unavailable": "🌿 Subsesiones: no disponible",
  "session.more": "…y {count} más",
  ...
  "mcps.detail.needs_auth_hint": "🔐 Se requiere inicio de sesión OAuth. Toca Iniciar sesión abajo para autorizar este servidor MCP.",
  "mcps.detail.needs_client_registration_hint": "🪪 Este servidor requiere un cliente OAuth preregistrado. Configura aquí el Client ID y el Client Secret opcional, luego continúa con Iniciar sesión.",
  "mcps.auth.sign_in_title": "🔐 Iniciar sesión en {name}",
  "mcps.auth.sign_in_steps": "1. Toca Abrir inicio de sesión y completa la autorización en el navegador.\n2. Si el navegador termina en una página localhost no disponible, copia la URL completa de la barra de direcciones.\n3. Envía esa URL de callback completa aquí.\n\nEl código de autorización se elimina de Telegram de inmediato y nunca se envía al modelo.",
  "mcps.auth.cancelled": "Configuración de autenticación cancelada.",
  "mcps.auth.login_cancelled": "Inicio de sesión MCP cancelado.",
  "mcps.auth.setup_cancelled": "Configuración MCP cancelada.",
  "mcps.auth.not_waiting_oauth": "Este servidor MCP no está esperando el inicio de sesión OAuth.",
  "mcps.auth.opening_login": "Abriendo inicio de sesión MCP seguro…",
  "mcps.auth.menu_title": "🔐 Autenticación · {name}",
  "mcps.auth.server_line": "Servidor: {url}",
  "mcps.auth.menu_prompt": "Elige cómo se autentica este servidor MCP remoto.",
  "mcps.auth.menu_options": "✨ Automático / OAuth — recomendado cuando el servidor admite inicio de sesión en el navegador\n🔑 Token Bearer — Authorization: Bearer …\n🗝 API Key — X-API-Key por defecto\n🧩 Encabezado personalizado — para encabezados del proveedor\n🪪 Cliente OAuth — Client ID / Secret preregistrado",
  "mcps.auth.secrets_note": "El bot cifra los secretos y nunca los muestra al modelo.",
  "mcps.auth.outside_context": "🔒 Las credenciales permanecen fuera del contexto del modelo.",
  "mcps.auth.header_name_prompt": "Envía el nombre del encabezado HTTP que usa este servidor MCP.\n\nEjemplo: X-Service-Token",
  "mcps.auth.bearer_prompt": "Envía el token bearer.\n\nEl mensaje se eliminará de inmediato.",
  "mcps.auth.api_key_prompt": "Envía la clave API para X-API-Key.\n\nEl mensaje se eliminará de inmediato.",
  "mcps.auth.custom_header_prompt": "Envía el valor para {header}.\n\nEl mensaje se eliminará de inmediato.",
  "mcps.auth.client_id_prompt": "Envía el Client ID de OAuth preregistrado.",
  "mcps.auth.client_secret_prompt": "Envía el Client Secret o toca Omitir secreto si es un cliente público.\n\nEl mensaje se eliminará de inmediato.",
  "mcps.auth.scope_prompt": "Envía el alcance OAuth que solicita el proveedor o toca Omitir alcance para usar el valor predeterminado del servidor.",
  "mcps.auth.configure_failed": "❌ No se pudo configurar la autenticación.\nRevisa la credencial o los ajustes del proveedor e inténtalo de nuevo.\n\nEl secreto enviado no se mostró ni se registró.",
  "mcps.auth.mode.bearer": "Token Bearer",
  "mcps.auth.mode.api_key": "Clave API",
  "mcps.auth.mode.custom_header": "Encabezado personalizado",
  "mcps.auth.mode.oauth_client": "Cliente OAuth",
  "mcps.auth.step_title": "🔐 {mode} · {name}",
  "mcps.auth.step_title_client": "🪪 Cliente OAuth · {name}",
  "mcps.button.rename": "✏️ Renombrar",
  "mcps.button.delete": "🗑 Eliminar",
  "mcps.button.confirm_delete": "🗑 Sí, eliminar",
  "mcps.rename.prompt": "✏️ Renombrar servidor MCP\n\nNombre actual: {name}\n\nEnvía el nuevo nombre.",
  "mcps.rename.retry": "✏️ Renombrar servidor MCP\n\n❌ {error}\n\nEnvía otro nombre.",
  "mcps.rename.name_too_long": "El nombre debe tener 128 caracteres o menos.",
  "mcps.delete.confirm": "🗑 Eliminar servidor MCP\n\n¿Eliminar {name}?\n\nSe eliminarán la definición y la autenticación guardada y se desconectará de los runtimes activos.",
  "mcps.deleted": "Servidor MCP {name} eliminado.",
  "mcps.auth.account": "👤 Cuenta: {identity}{provider}",
  "mcps.auth.account_unknown": "👤 Cuenta: Sesión iniciada{provider} · el proveedor no expuso correo/usuario",
  "model.fallback.notice": "⚠️ El modelo seleccionado {previous} no está disponible o no es apto para agente. Se cambió a {next}.",
