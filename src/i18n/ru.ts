...
export const ru: I18nDictionary = {
  ...
  "bot.empty_response":
    "⚠️ Модель завершилась, не выдав текста. Попробуйте переформулировать запрос или используйте /abort и повторите.",
  "bot.session_stalled":
    "⏸️ Модель перестала прогрессировать, и запуск был остановлен. Ответ не получен; повторите попытку.",
