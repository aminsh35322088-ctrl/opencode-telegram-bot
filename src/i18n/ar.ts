...
export const ar: I18nDictionary = {
  ...
  "bot.empty_response":
    "⚠️ انتهى النموذج دون إنتاج أي نص. حاول إعادة صياغة الطلب أو استخدم /abort وأعد المحاولة.",
  "bot.session_stalled":
    "⏸️ توقف النموذج عن إحراز تقدم وتم إيقاف التشغيل. لم يتم إنتاج أي رد؛ يرجى إعادة المحاولة.",
  ...
  "messages.redo_error": "❌ تعذّرت إعادة التنفيذ. حاول مرة أخرى.",
  ...
  "session.no_session": "ℹ️ لا توجد جلسة OpenCode نشطة. افتح جلسة أو اتصل بها أولاً.",
  "session.header": "🧭 جلسة OpenCode",
  "session.state": "الحالة: {status}",
  "session.status_idle": "🟢 خاملة",
  "session.status_busy": "🟡 مشغولة",
  "session.status_retry": "🔁 إعادة محاولة",
  "session.status_unknown": "⚪ غير معروف",
  "session.todos_none": "📝 المهام: لا شيء",
  "session.todos_summary": "📝 المهام: {total} إجمالاً · {active} نشطة · {done} منجزة",
  "session.todos_unavailable": "📝 المهام: غير متوفر",
  "session.changes_none": "🧩 التغييرات: لا شيء",
  "session.changes_summary": "🧩 التغييرات: {files} ملف · +{additions} / -{deletions}",
  "session.changes_unavailable": "🧩 التغييرات: غير متوفر",
  "session.children_none": "🌿 الجلسات الفرعية: لا شيء",
  "session.children_summary": "🌿 الجلسات الفرعية: {count}",
  "session.children_unavailable": "🌿 الجلسات الفرعية: غير متوفر",
  "session.more": "…و{count} أخرى",
  ...
  "skills.button.import": "📥 استيراد من GitHub",
  "skills.button.import_confirm": "⬇️ استيراد",
  "skills.import.ask_url": "أرسل رابط GitHub للمهارة: مستودع أو مجلد المهارة أو ملف SKILL.md.",
  "skills.import.invalid_url": "⚠️ هذا ليس رابط GitHub صالحاً. أرسل رابط مستودع أو مجلد أو ملف SKILL.md.",
  "skills.import.not_found": "🔴 لم يتم العثور على SKILL.md في هذا الموقع على GitHub.",
  "skills.import.fetch_error": "🔴 تعذّر الجلب من GitHub: {error}",
  "skills.import.confirm": "هل تريد استيراد المهارة {skill}؟\n\n{description}\n\n📍 المصدر: {url}",
  "skills.import.multiple_found": "تم العثور على {count} مهارات في هذا الموقع. اختر واحدة للاستيراد:",
  "skills.imported": "✅ تم استيراد المهارة \"{name}\" من GitHub.",
  "skills.import.exists": "⚠️ المهارة \"{name}\" موجودة بالفعل. عدّلها أو احذفها أولاً.",
  "skills.import.cancelled": "تم إلغاء استيراد المهارة.",
