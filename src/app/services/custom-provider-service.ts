...
export type AiCapability = "coding" | "image" | "image-conversation" | "video" | "stt";
...
function normalizeCapability(value: unknown): AiCapability { return value === "image" || value === "image-conversation" || value === "video" || value === "stt" ? value : "coding"; }
